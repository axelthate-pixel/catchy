...
class CatchyUnitTest {
    ...
    @Test
    fun fangWirdKorrektAlsJsonSerialisiert() {
    ...
    @Test
    fun fangWirdKorrektAusJsonDeserialisiert() {
    ...
    @Test
    fun alterFangOhneGezeitenfeldCraashtNicht() {
    ...
    @Test
    fun gezeigenLeerWennKeinGpsVorhanden() {
    ...
    @Test
    fun fangCopyBehaeltAllleFelderKorrekt() {
    ...
    @Test
    fun fangStandardwerteSindKorrekt() {
